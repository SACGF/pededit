...
export const simpleFamily: Pedigree = {
  individuals: [
    ...
    { id: "i3", sex: "male",    affected: true,  deceased: true  },     // father
    { id: "i4", sex: "female",  affected: false },                      // aunt (sibling of i3)
    { id: "i5", sex: "female",  affected: false },                      // mother (marry-in)
    { id: "i6", sex: "female",  affected: true,  proband: true   },     // proband
    { id: "i7", sex: "male",    affected: false },
    { id: "i8", sex: "female",  affected: false, carrier: true  },
  ],
  partnerships: [
